    ...
    */
    ...
    var body: some View {
        VStack{
            ...
            Spacer()
            Text("Roll Count " + String(self.diceStates.allDiceStates.RollCount))
            sixDice()
            
            if self.diceStates.allDiceStates.RollCount < 3 {
                Button(action: {
                    //self.diceStates.allDiceStates.Dice1.0 = Int.random(in: 1...6)
                    
                    self.diceRoll(lockStatus: self.diceStates.allDiceStates.Dice1.1, diceFace: &(self.diceStates.allDiceStates.Dice1.0))
                    self.diceRoll(lockStatus: self.diceStates.allDiceStates.Dice2.1, diceFace: &(self.diceStates.allDiceStates.Dice2.0))
                    self.diceRoll(lockStatus: self.diceStates.allDiceStates.Dice3.1, diceFace: &(self.diceStates.allDiceStates.Dice3.0))
                    self.diceRoll(lockStatus: self.diceStates.allDiceStates.Dice4.1, diceFace: &(self.diceStates.allDiceStates.Dice4.0))
                    self.diceRoll(lockStatus: self.diceStates.allDiceStates.Dice5.1, diceFace: &(self.diceStates.allDiceStates.Dice5.0))
                    self.diceRoll(lockStatus: self.diceStates.allDiceStates.Dice6.1, diceFace: &(self.diceStates.allDiceStates.Dice6.0))
                    self.diceStates.allDiceStates.RollCount += 1
                    },
    ...
    func resetAll(){
        ...
        self.diceStates.allDiceStates.Dice1.0 = 0
        self.diceStates.allDiceStates.Dice2.0 = 0
        self.diceStates.allDiceStates.Dice3.0 = 0
        self.diceStates.allDiceStates.Dice4.0 = 0
        self.diceStates.allDiceStates.Dice5.0 = 0
        self.diceStates.allDiceStates.Dice6.0 = 0
        self.diceStates.allDiceStates.Dice7.0 = 0
        //reset roll count to 0
        self.diceStates.allDiceStates.RollCount = 0
        ...
        self.diceStates.allDiceStates.Dice1.1 = false
        self.diceStates.allDiceStates.Dice2.1 = false
        self.diceStates.allDiceStates.Dice3.1 = false
        self.diceStates.allDiceStates.Dice4.1 = false
        self.diceStates.allDiceStates.Dice5.1 = false
        self.diceStates.allDiceStates.Dice6.1 = false
        self.diceStates.allDiceStates.Dice7.1 = false
    }
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        ContentView().environmentObject(SixDiceStates())
    }
}
